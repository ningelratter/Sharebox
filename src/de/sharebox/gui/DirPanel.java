...
<html>
  <head>
    ...
    <script type="text/javascript">var NREUMQ=[];NREUMQ.push(["mark","firstbyte",new Date().getTime()]);</script>
        <title>src/de/sharebox/gui/DirPanel.java at master from ningelratter/Sharebox - GitHub</title>
  ...
  <link rel='canonical' href='/ningelratter/Sharebox/blob/30ffb9f4b528feed2b03a8327190b2d4e31092fe/src/de/sharebox/gui/DirPanel.java'>
  ...
  <link href="https://github.com/ningelratter/Sharebox/commits/master.atom" rel="alternate" title="Recent Commits to Sharebox:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'src/de/sharebox/gui/DirPanel.java';
  ...
  <body class="logged_out page-blob  windows env-production">
    ...
    <ul class="nav logged_out">
      ...
      <li class="login"><a href="/login?return_to=%2Fningelratter%2FSharebox%2Fblob%2Fmaster%2Fsrc%2Fde%2Fsharebox%2Fgui%2FDirPanel.java">Login</a></li>
    </ul>
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="src/de/sharebox/gui/DirPanel.java/">
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_2282&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_2282&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="src/de/sharebox/gui/DirPanel.java/" data-canonical-url="/ningelratter/Sharebox/blob/30ffb9f4b528feed2b03a8327190b2d4e31092fe/src/de/sharebox/gui/DirPanel.java">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/ningelratter/Sharebox/edit/__current_ref__/src/de/sharebox/gui/DirPanel.java"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/ningelratter/Sharebox/raw/master/src/de/sharebox/gui/DirPanel.java" id="raw-url">raw</a></li>
                
                  <li><a href="/ningelratter/Sharebox/blame/master/src/de/sharebox/gui/DirPanel.java">blame</a></li>
                
                <li><a href="/ningelratter/Sharebox/commits/master/src/de/sharebox/gui/DirPanel.java">history</a></li>
              </ul>
            </div>
...
<span id="L24" rel="#L24">24</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="kn">package</span> <span class="n">de</span><span class="o">.</span><span class="na">sharebox</span><span class="o">.</span><span class="na">gui</span><span class="o">;</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="kn">import</span> <span class="nn">javax.swing.JTree</span><span class="o">;</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'><span class="kn">import</span> <span class="nn">de.sharebox.controller.Controller</span><span class="o">;</span></div><div class='line' id='LC6'><br/></div><div class='line' id='LC7'><span class="cm">/**</span></div><div class='line' id='LC8'><span class="cm"> * ? TODO describe the function of this class </span></div><div class='line' id='LC9'><span class="cm"> * </span></div><div class='line' id='LC10'><span class="cm"> * @author MW</span></div><div class='line' id='LC11'><span class="cm"> * @version 11.06.11</span></div><div class='line' id='LC12'><span class="cm"> *</span></div><div class='line' id='LC13'><span class="cm"> */</span></div><div class='line' id='LC14'><br/></div><div class='line' id='LC15'><span class="kd">public</span> <span class="kd">class</span> <span class="nc">DirPanel</span> <span class="kd">extends</span> <span class="n">ChangeablePanel</span> <span class="o">{</span></div><div class='line' id='LC16'>	<span class="kd">public</span> <span class="nf">DirPanel</span><span class="o">(</span><span class="n">Controller</span> <span class="n">c</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC17'>		<span class="kd">super</span><span class="o">(</span><span class="n">c</span><span class="o">);</span></div><div class='line' id='LC18'><br/></div><div class='line' id='LC19'>		<span class="n">JTree</span> <span class="n">tree</span> <span class="o">=</span> <span class="k">new</span> <span class="n">JTree</span><span class="o">();</span></div><div class='line' id='LC20'>		<span class="n">tree</span><span class="o">.</span><span class="na">setBounds</span><span class="o">(</span><span class="mi">119</span><span class="o">,</span> <span class="mi">144</span><span class="o">,</span> <span class="mi">179</span><span class="o">,</span> <span class="mi">155</span><span class="o">);</span></div><div class='line' id='LC21'>		<span class="n">add</span><span class="o">(</span><span class="n">tree</span><span class="o">);</span></div><div class='line' id='LC22'>	<span class="o">}</span></div><div class='line' id='LC23'>	<span class="o">}</span></div><div class='line' id='LC24'><br/></div></pre></div>
  ...
  <img src="https://a248.e.akamai.net/assets.github.com/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.04554s from fe1.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
