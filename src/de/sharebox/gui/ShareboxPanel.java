...
<html>
  <head>
    ...
    <script type="text/javascript">var NREUMQ=[];NREUMQ.push(["mark","firstbyte",new Date().getTime()]);</script>
        <title>src/de/sharebox/gui/ShareboxPanel.java at master from ningelratter/Sharebox - GitHub</title>
  ...
  <link rel='canonical' href='/ningelratter/Sharebox/blob/30ffb9f4b528feed2b03a8327190b2d4e31092fe/src/de/sharebox/gui/ShareboxPanel.java'>
  ...
  <link href="https://github.com/ningelratter/Sharebox/commits/master.atom" rel="alternate" title="Recent Commits to Sharebox:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'src/de/sharebox/gui/ShareboxPanel.java';
  ...
  <body class="logged_out page-blob  windows env-production">
    ...
    <ul class="nav logged_out">
      ...
      <li class="login"><a href="/login?return_to=%2Fningelratter%2FSharebox%2Fblob%2Fmaster%2Fsrc%2Fde%2Fsharebox%2Fgui%2FShareboxPanel.java">Login</a></li>
    </ul>
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="src/de/sharebox/gui/ShareboxPanel.java/">
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_1906&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_1906&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="src/de/sharebox/gui/ShareboxPanel.java/" data-canonical-url="/ningelratter/Sharebox/blob/30ffb9f4b528feed2b03a8327190b2d4e31092fe/src/de/sharebox/gui/ShareboxPanel.java">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/ningelratter/Sharebox/edit/__current_ref__/src/de/sharebox/gui/ShareboxPanel.java"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/ningelratter/Sharebox/raw/master/src/de/sharebox/gui/ShareboxPanel.java" id="raw-url">raw</a></li>
                
                  <li><a href="/ningelratter/Sharebox/blame/master/src/de/sharebox/gui/ShareboxPanel.java">blame</a></li>
                
                <li><a href="/ningelratter/Sharebox/commits/master/src/de/sharebox/gui/ShareboxPanel.java">history</a></li>
              </ul>
            </div>
...
<span id="L29" rel="#L29">29</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="kn">package</span> <span class="n">de</span><span class="o">.</span><span class="na">sharebox</span><span class="o">.</span><span class="na">gui</span><span class="o">;</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="kn">import</span> <span class="nn">javax.swing.JPanel</span><span class="o">;</span></div><div class='line' id='LC4'><br/></div><div class='line' id='LC5'><span class="kn">import</span> <span class="nn">de.sharebox.controller.Controller</span><span class="o">;</span></div><div class='line' id='LC6'><br/></div><div class='line' id='LC7'><span class="cm">/**</span></div><div class='line' id='LC8'><span class="cm"> * At the moment I don&#39;t know why we need this class. :( :)</span></div><div class='line' id='LC9'><span class="cm"> * @author Eilin</span></div><div class='line' id='LC10'><span class="cm"> * @version 11.06.11</span></div><div class='line' id='LC11'><span class="cm"> *  </span></div><div class='line' id='LC12'><span class="cm"> */</span></div><div class='line' id='LC13'><br/></div><div class='line' id='LC14'><span class="kd">public</span> <span class="kd">abstract</span> <span class="kd">class</span> <span class="nc">ShareboxPanel</span> <span class="kd">extends</span> <span class="n">JPanel</span> <span class="o">{</span></div><div class='line' id='LC15'><br/></div><div class='line' id='LC16'>	<span class="cm">/**</span></div><div class='line' id='LC17'><span class="cm">	 * EVERY Panel needs a serialVersionUID</span></div><div class='line' id='LC18'><span class="cm">	 */</span></div><div class='line' id='LC19'>	<span class="kd">private</span> <span class="kd">static</span> <span class="kd">final</span> <span class="kt">long</span> <span class="n">serialVersionUID</span> <span class="o">=</span> <span class="o">-</span><span class="mi">8030564383947937101L</span><span class="o">;</span></div><div class='line' id='LC20'><br/></div><div class='line' id='LC21'>	<span class="c1">// protected damit Kindklassen drauf zugreifen k�nnen</span></div><div class='line' id='LC22'>	<span class="kd">protected</span> <span class="n">Controller</span> <span class="n">controller</span><span class="o">;</span></div><div class='line' id='LC23'><br/></div><div class='line' id='LC24'>	<span class="c1">//constructor calls the controller</span></div><div class='line' id='LC25'>	<span class="kd">public</span> <span class="nf">ShareboxPanel</span><span class="o">(</span><span class="n">Controller</span> <span class="n">controller</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC26'>		<span class="k">this</span><span class="o">.</span><span class="na">controller</span> <span class="o">=</span> <span class="n">controller</span><span class="o">;</span></div><div class='line' id='LC27'>	<span class="o">}</span></div><div class='line' id='LC28'><span class="o">}</span></div><div class='line' id='LC29'><br/></div></pre></div>
  ...
  <img src="https://a248.e.akamai.net/assets.github.com/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.12984s from fe4.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
