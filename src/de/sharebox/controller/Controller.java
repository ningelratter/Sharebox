...
<html>
  <head>
    ...
    <script type="text/javascript">var NREUMQ=[];NREUMQ.push(["mark","firstbyte",new Date().getTime()]);</script>
        <title>src/de/sharebox/controller/Controller.java at master from ningelratter/Sharebox - GitHub</title>
  ...
  <link rel='canonical' href='/ningelratter/Sharebox/blob/30ffb9f4b528feed2b03a8327190b2d4e31092fe/src/de/sharebox/controller/Controller.java'>
  ...
  <link href="https://github.com/ningelratter/Sharebox/commits/master.atom" rel="alternate" title="Recent Commits to Sharebox:master" type="application/atom+xml" />
    ...
    <script type="text/javascript">
      ...
      GitHub.currentPath = 'src/de/sharebox/controller/Controller.java';
  ...
  <body class="logged_out page-blob  windows env-production">
    ...
    <ul class="nav logged_out">
      ...
      <li class="login"><a href="/login?return_to=%2Fningelratter%2FSharebox%2Fblob%2Fmaster%2Fsrc%2Fde%2Fsharebox%2Fcontroller%2FController.java">Login</a></li>
    </ul>
...
<div class="flash-messages"></div>
  ...
  <div id="slider">
    ...
    <div class="breadcrumb" data-path="src/de/sharebox/controller/Controller.java/">
      ...
      <param name="quality" value="high" />
      <param name="scale" value="noscale" />
      <param NAME="FlashVars" value="id=clippy_951&amp;copied=copied!&amp;copyto=copy to clipboard">
      <param name="bgcolor" value="#FFFFFF">
      <param name="wmode" value="opaque">
      <embed src="https://a248.e.akamai.net/assets.github.com/flash/clippy.swf?v5"
             width="110"
             ...
             type="application/x-shockwave-flash"
             pluginspage="http://www.macromedia.com/go/getflashplayer"
             FlashVars="id=clippy_951&amp;copied=copied!&amp;copyto=copy to clipboard"
             bgcolor="#FFFFFF"
             wmode="opaque"
      />
      </object>
    ...
    <div class="frames">
      <div class="frame frame-center" data-path="src/de/sharebox/controller/Controller.java/" data-canonical-url="/ningelratter/Sharebox/blob/30ffb9f4b528feed2b03a8327190b2d4e31092fe/src/de/sharebox/controller/Controller.java">
        
          <ul class="big-actions">
            
            <li><a class="file-edit-link minibutton" href="/ningelratter/Sharebox/edit/__current_ref__/src/de/sharebox/controller/Controller.java"><span>Edit this file</span></a></li>
          </ul>
        ...
        <div id="files">
          <div class="file">
            <div class="meta">
              ...
              <ul class="actions">
                <li><a href="/ningelratter/Sharebox/raw/master/src/de/sharebox/controller/Controller.java" id="raw-url">raw</a></li>
                
                  <li><a href="/ningelratter/Sharebox/blame/master/src/de/sharebox/controller/Controller.java">blame</a></li>
                
                <li><a href="/ningelratter/Sharebox/commits/master/src/de/sharebox/controller/Controller.java">history</a></li>
              </ul>
            </div>
...
<span id="L59" rel="#L59">59</span>
          ...
          <td width="100%">
                ...
                <div class="highlight"><pre><div class='line' id='LC1'><span class="kn">package</span> <span class="n">de</span><span class="o">.</span><span class="na">sharebox</span><span class="o">.</span><span class="na">controller</span><span class="o">;</span></div><div class='line' id='LC2'><br/></div><div class='line' id='LC3'><span class="kn">import</span> <span class="nn">de.sharebox.gui.User</span><span class="o">;</span></div><div class='line' id='LC4'><span class="kn">import</span> <span class="nn">de.sharebox.services.UserService</span><span class="o">;</span></div><div class='line' id='LC5'><br/></div><div class='line' id='LC6'><span class="cm">/**</span></div><div class='line' id='LC7'><span class="cm"> * This class controll the services (UserService, FileService,</span></div><div class='line' id='LC8'><span class="cm"> * DirectoryService).</span></div><div class='line' id='LC9'><span class="cm"> * </span></div><div class='line' id='LC10'><span class="cm"> * @author Eilin</span></div><div class='line' id='LC11'><span class="cm"> * @version 11.06.11</span></div><div class='line' id='LC12'><span class="cm"> * </span></div><div class='line' id='LC13'><span class="cm"> */</span></div><div class='line' id='LC14'><br/></div><div class='line' id='LC15'><span class="kd">public</span> <span class="kd">class</span> <span class="nc">Controller</span> <span class="o">{</span></div><div class='line' id='LC16'><br/></div><div class='line' id='LC17'>	<span class="kd">private</span> <span class="n">UserService</span> <span class="n">userService</span><span class="o">;</span></div><div class='line' id='LC18'><br/></div><div class='line' id='LC19'>	<span class="c1">// constructor</span></div><div class='line' id='LC20'>	<span class="c1">// constructor</span></div><div class='line' id='LC21'>	<span class="kd">public</span> <span class="nf">Controller</span><span class="o">()</span> <span class="o">{</span></div><div class='line' id='LC22'>		<span class="n">userService</span> <span class="o">=</span> <span class="k">new</span> <span class="n">UserService</span><span class="o">();</span></div><div class='line' id='LC23'>	<span class="o">}</span></div><div class='line' id='LC24'><br/></div><div class='line' id='LC25'>	<span class="cm">/**</span></div><div class='line' id='LC26'><span class="cm">	 * call to create a user in the userService From type User.</span></div><div class='line' id='LC27'><span class="cm">	 * </span></div><div class='line' id='LC28'><span class="cm">	 * @param name</span></div><div class='line' id='LC29'><span class="cm">	 * @param password</span></div><div class='line' id='LC30'><span class="cm">	 * @param mail</span></div><div class='line' id='LC31'><span class="cm">	 * @return a user with his properties</span></div><div class='line' id='LC32'><span class="cm">	 */</span></div><div class='line' id='LC33'>	<span class="kd">public</span> <span class="n">User</span> <span class="nf">createUser</span><span class="o">(</span><span class="n">String</span> <span class="n">name</span><span class="o">,</span> <span class="n">String</span> <span class="n">password</span><span class="o">,</span> <span class="n">String</span> <span class="n">mail</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC34'>		<span class="k">return</span> <span class="n">userService</span><span class="o">.</span><span class="na">createUser</span><span class="o">(</span><span class="n">name</span><span class="o">,</span> <span class="n">password</span><span class="o">,</span> <span class="n">mail</span><span class="o">);</span></div><div class='line' id='LC35'>	<span class="o">}</span></div><div class='line' id='LC36'><br/></div><div class='line' id='LC37'>	<span class="cm">/**</span></div><div class='line' id='LC38'><span class="cm">	 * @author Eilin</span></div><div class='line' id='LC39'><span class="cm">	 * @param name</span></div><div class='line' id='LC40'><span class="cm">	 * @param password</span></div><div class='line' id='LC41'><span class="cm">	 * @return the user</span></div><div class='line' id='LC42'><span class="cm">	 */</span></div><div class='line' id='LC43'>	<span class="kd">public</span> <span class="n">User</span> <span class="nf">getUser</span><span class="o">(</span><span class="n">String</span> <span class="n">name</span><span class="o">,</span> <span class="n">String</span> <span class="n">password</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC44'>		<span class="k">return</span> <span class="n">userService</span><span class="o">.</span><span class="na">getUserByName</span><span class="o">(</span><span class="n">name</span><span class="o">,</span> <span class="n">password</span><span class="o">);</span></div><div class='line' id='LC45'>	<span class="o">}</span></div><div class='line' id='LC46'><br/></div><div class='line' id='LC47'>	<span class="cm">/**</span></div><div class='line' id='LC48'><span class="cm">	 * @param args</span></div><div class='line' id='LC49'><span class="cm">	 */</span></div><div class='line' id='LC50'>	<span class="kd">public</span> <span class="kd">static</span> <span class="kt">void</span> <span class="nf">main</span><span class="o">(</span><span class="n">String</span><span class="o">[]</span> <span class="n">args</span><span class="o">)</span> <span class="o">{</span></div><div class='line' id='LC51'><br/></div><div class='line' id='LC52'>	<span class="o">}</span></div><div class='line' id='LC53'><br/></div><div class='line' id='LC54'>	<span class="kd">public</span> <span class="kt">void</span> <span class="nf">saveData</span><span class="o">()</span> <span class="o">{</span></div><div class='line' id='LC55'>		<span class="n">userService</span><span class="o">.</span><span class="na">saveUsers</span><span class="o">();</span></div><div class='line' id='LC56'>	<span class="o">}</span></div><div class='line' id='LC57'><br/></div><div class='line' id='LC58'><span class="o">}</span></div><div class='line' id='LC59'><br/></div></pre></div>
  ...
  <img src="https://a248.e.akamai.net/assets.github.com/images/modules/ajax/big_spinner_336699.gif" height="32" width="32">
    ...
    <div id="footer" class="clearfix">
      <div class="site">
        ...
        <ul class="sosueme">
          <li class="main">&copy; 2011 <span id="_rrt" title="0.22068s from fe4.rs.github.com">GitHub</span> Inc. All rights reserved.</li>
